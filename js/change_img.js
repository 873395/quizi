 let zdj_lista=[
        "https://cdnb.artstation.com/p/assets/images/images/041/782/087/large/adrian-ziajor-6sd.jpg?1632683135",
    ...
    let akt_zdj=0;
    let a = document.getElementById("c_box_img_1");
    ...
    function czas_wczytaj()
    {
        ...
        a.src=zdj_lista[akt_zdj];

        setTimeout(czas_wczytaj,5000);
    }
