...
let zdjecia=[
    ...
    '<br><img src="img/quiz/2.jpg" title="Prawa autorskie"></img>',
    '<br><img src="img/quiz/3.jpg" title="Prawa autorskie"></img>',
    '<br><img src="img/quiz/4.jpg" title="Prawa autorskie"></img>',
    '<br><img src="img/quiz/5.jpg" title="Prawa autorskie"></img>',
    '<br><img src="img/quiz/6.jpg" title="Prawa autorskie"></img>',
...
let pytania=[
    ...
    "B",
    op_kategoria[0]],
    [`Który z portów na panelu tylnym komputera oznacza się przedstawionym symbolem? ${zdjecia[0]}`,
    "LPT",
    "USB",
    "COM",
    "B",
    op_kategoria[0]],
    [`Który z symboli oznacza zastrzeżenie praw autorskich? ${zdjecia[1]}`,
    "A",
    "B",
    "C",
    "A",
    op_kategoria[0]],
    [`Wskaż podzespół niekompatybilny z płytą główną o przedstawionych w tabeli parametrach ${zdjecia[2]}`,
    ...
    "A",
    op_kategoria[0]],
    [`Który port na przedstawionej płycie umożliwia podłączenie zewnętrznego dysku poprzez interfejs e-SATA? ${zdjecia[3]}`,
    "1",
    "4",
    "2",
    "C",
    ...
    "C",
    op_kategoria[1]],
    [`Autor zamieszczonego oprogramowania zezwala na jego bezpłatne używanie jedynie w przypadku ${zdjecia[4]}`,
    ...
    "A",
    op_kategoria[2]],
    [`Na rysunku przedstawiono fragment wyniku działania programu do testowania sieci. Wskazuje to na zastosowanie sieciowego polecenia testującego ${zdjecia[5]}`,
    "route",
    "tracert",
    "netstat",
    "C",
    op_kategoria[2]],
    [`Które urządzenie zostało przedstawione na rysunku? ${zdjecia[6]}`,
    "Punkt dostępu",
    "Modem",
    "Ruter",
    "A",
    op_kategoria[2]],
    [`Na zamieszczonym zrzucie panelu konfiguracyjnego rutera widać, że serwer DHCP ${zdjecia[7]}`,
    ...
    [`W przedstawionym fragmencie kwerendy języka SQL, komenda SELECT ma za zadanie zwrócić ${zdjecia[8]}`,
    "liczbę wierszy",
